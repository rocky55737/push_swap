...
#    Updated: 2022/11/10 18:24:04 by rhong            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ./src/deq_utils.c ./src/deq_utils2.c ./src/deq_utils3.c ./src/deq_utils4.c ./src/deq_utils5.c ./src/find_a_move_cnt.c ./src/find_index_by_data.c ./src/free_char_ptr_arr.c ./src/ft_str_ptr_cat.c ./src/get_least_move_data.c ./src/hard_sort.c ./src/input_err.c ./src/judging_move.c ./src/main.c ./src/malloc_null_guard.c ./src/many_sort.c ./src/push_data_to_deq.c ./src/push_swap_utils.c ./src/push_swap_utils2.c ./src/push_swap_utils3.c ./src/push_swap.c ./src/set_index.c ./src/sort_five.c ./src/sort_five2.c ./src/sort_four.c ./src/sort_three.c ./src/sort.c ./src/write_err.c
